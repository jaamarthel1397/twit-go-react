...
/* LeoUsuariosTodos lee los usuarios regsitrados en el sistema, si se recibe "R" en quienes
...
func LeoUsuariosTodos(ID string, page int64, search string, tipo string) ([]*models.Usuario, bool) {
	...
	query := bson.M{
		"nombre": bson.M{"$regex": `(?i)` + search}, //la i indica que no es case sensitive
	}
